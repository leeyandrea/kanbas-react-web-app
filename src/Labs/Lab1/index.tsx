    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li>
            add 1 tbsp soy sauce, 1 tbsp sesame oil, and 1 tbsp warm water.
          </li>
      ...
      <div id="wd-forms">
        ...
        <a
          id="wd-github"
          href="https://github.com/leeyandrea/kanbas-react-web-app/tree/a1"
        >
          {" "}
          click here{" "}
        </a>
        for the code repository on GitHub
        <br />
      </div>
    </div>
  );
